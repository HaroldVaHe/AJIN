...
const staticPages = [
  ...
  { path: '/servicios/derecho-laboral', priority: '0.8' },
  { path: '/servicios/derecho-familia', priority: '0.8' },
  { path: '/servicios/derecho-civil', priority: '0.8' },
  { path: '/servicios/derecho-comercial', priority: '0.8' },
  { path: '/servicios/derecho-administrativo', priority: '0.8' },
