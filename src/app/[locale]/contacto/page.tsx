      ...
      <Section>
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-2xl overflow-hidden h-[300px] bg-ajin-gray-100 flex items-center justify-center text-ajin-gray-400 text-sm">
              <div className="relative rounded-2xl overflow-hidden h-[350px] border border-gray-200 shadow-sm">
                <a
                  href="https://maps.app.goo.gl/jWZxs9ED1DQqqXwL7"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="absolute top-4 right-4 z-20 bg-white/95 backdrop-blur-sm rounded-lg px-3 py-2 shadow-md hover:shadow-lg transition-all flex items-center gap-2 text-sm font-medium"
                >
                  <ExternalLink size={16} />
                  Abrir en Maps
                </a>

                {/* <div className="absolute top-4 left-4 z-20 bg-[#8EC83F] text-black rounded-lg px-3 py-2 shadow-md flex items-center gap-2 font-medium">
                  <MapPin size={16} />
                  AJIN
                </div> */}
